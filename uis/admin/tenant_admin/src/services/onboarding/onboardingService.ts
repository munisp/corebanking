...
export type TenantRole =
  ...
  | "operations_manager" // Transactions & tellers
  | "risk_manager" // Risk, limits & compliance
  | "internal_auditor" // View all data & audit
  | "it_admin" // System & ERP management
  | "relationship_manager" // Customer relations
  | "trade_finance_admin" // LPO & trade finance
  | "vault_manager" // Vault & cash management
...
export interface OnboardingData {
  ...
  // Step 4: Tenant Role (v2.perm `tenants` entity)
