...
export default function KYC() {
  ...
  return (
    ...
    >
      {/* Header with Logo */}
      <div className="w-full py-6 px-4 border-b border-border dark:border-slate-700 bg-card/80 backdrop-blur-sm">
      ...
      <div className="flex-1 container py-8">
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 shadow-lg border-0 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 dark:text-green-300">
                      Your information has been submitted. KYC verification is
                      in progress.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-background dark:bg-slate-800 rounded-lg p-6">
              <h3 className="font-semibold mb-2">Next Steps</h3>
              <p className="text-sm text-muted-foreground dark:text-gray-400 mb-4">
                Your KYC verification is being processed. This typically takes
                24-48 hours. You will be notified once the verification is
                complete.
              </p>
              <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                Note: This is a placeholder screen. Replace with actual KYC
