import { Bell, Mail, Save, Settings, TestTube, Webhook } from "lucide-react";
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({
                    ...config,
                    spikeThreshold: parseFloat(e.target.value),
                  })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({
                    ...config,
                    tenantActivityThreshold: parseFloat(e.target.value),
                  })
                }
                className="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({
                    ...config,
                    totalCallsThreshold: parseInt(e.target.value),
                  })
                }
                className="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground"
              />
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setConfig({ ...config, teamsWebhookUrl: e.target.value })
                  }
                  className="flex-1 px-4 py-2 border border-border rounded-lg bg-background text-foreground"
                />
                <button
