...
export default function MakerCheckerWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"entityType",label:"Type"},{key:"action",label:"Action"},{key:"currentLevel",label:"Level"},{key:"totalLevels",label:"Total"},{key:"status",label:"Status"},{key:"createdAt",label:"Created"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Maker-Checker Workflows</h1>
      {stats && (
