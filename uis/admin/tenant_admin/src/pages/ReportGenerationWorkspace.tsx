...
export default function ReportGenerationWorkspace() {
  ...
  useEffect(() => {
    fetch("/efass-kyc-returns/v1/returns")
      .then(r => r.json())
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"name",label:"Report"},{key:"format",label:"Format"},{key:"sizeBytes",label:"Size"},{key:"status",label:"Status"},{key:"generatedAt",label:"Generated"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Report Generation</h1>
      {stats && (
