...
54Bank Tigerbeetle Protocol service
...
# Run
PORT=8080 ./target/release/tigerbeetle-protocol-rs
```
...
```bash
docker build -t 54bank/tigerbeetle-protocol-rs .
docker run -p 8080:8080 54bank/tigerbeetle-protocol-rs
```
