...
54Bank Tigerbeetle Adapter service
...
# Run
PORT=8080 ./target/release/tigerbeetle-adapter-rs
```
...
```bash
docker build -t 54bank/tigerbeetle-adapter-rs .
docker run -p 8080:8080 54bank/tigerbeetle-adapter-rs
```
