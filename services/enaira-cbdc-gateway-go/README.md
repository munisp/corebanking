...
54Bank Enaira Cbdc Gateway service

## Quick Start

```bash
# Build
go build -o enaira-cbdc-gateway-go .

# Run
PORT=8100 ./enaira-cbdc-gateway-go
```
...
```bash
docker build -t 54bank/enaira-cbdc-gateway-go .
docker run -p 8100:8100 54bank/enaira-cbdc-gateway-go
```
