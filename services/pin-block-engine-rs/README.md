...
54Bank Pin Block Engine service
...
# Run
PORT=8080 ./target/release/pin-block-engine-rs
```
...
```bash
docker build -t 54bank/pin-block-engine-rs .
docker run -p 8080:8080 54bank/pin-block-engine-rs
```
