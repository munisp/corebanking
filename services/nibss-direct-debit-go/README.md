...
```bash
# Build
go build -o nibss-direct-debit-go .

# Run
PORT=6379 ./nibss-direct-debit-go
```
...
```bash
docker build -t 54bank/nibss-direct-debit-go .
docker run -p 6379:6379 54bank/nibss-direct-debit-go
```
