...
# Run
PORT=8106 ./target/release/platform-hardening-rs
```
...
```bash
docker build -t 54bank/platform-hardening-rs .
docker run -p 8106:8106 54bank/platform-hardening-rs
```
