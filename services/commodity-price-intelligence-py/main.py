...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            self._json(200, {"service": "commodity-price-intelligence-py", **_degrade.status()})
        elif path == "/v1/alerts":
...
_event_bus = EventBus("platform.events", "commodity-price-intelligence")


# --- Data Flow Emit Point ---
def emit_processing_event(action: str, data: dict) -> None:
    """Called by handlers after successful processing."""
    _event_bus.emit("commodity-price-intelligence." + action, data)
