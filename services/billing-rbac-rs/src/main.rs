...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[billing-rbac-rs] starting");

    let db_name = "billing-rbac-rs".replace("-", "_");
    ...
    log::info!("[billing-rbac-rs] database connected, schema initialized");
    ...
    log::info!("[billing-rbac-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[billing-rbac-rs] ready on :{}", port);
