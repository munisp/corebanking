...
# Run
PORT=8080 ./target/release/openappsec-waf-rs
```
...
```bash
docker build -t 54bank/openappsec-waf-rs .
docker run -p 8080:8080 54bank/openappsec-waf-rs
```
