...
54Bank Telegram Banking Commands service
...
# Run
PORT=8080 ./target/release/telegram-banking-commands-rs
```
...
```bash
docker build -t 54bank/telegram-banking-commands-rs .
docker run -p 8080:8080 54bank/telegram-banking-commands-rs
```
