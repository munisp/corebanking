# Tigerbeetle Batch Engine

54Bank Tigerbeetle Batch Engine service
...
# Run
PORT=8080 ./target/release/tigerbeetle-batch-engine-rs
```
...
```bash
docker build -t 54bank/tigerbeetle-batch-engine-rs .
docker run -p 8080:8080 54bank/tigerbeetle-batch-engine-rs
```
