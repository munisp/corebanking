...
```bash
# Build
go build -o post-harvest-loss-tracker-go .

# Run
PORT=6379 ./post-harvest-loss-tracker-go
```
...
```bash
docker build -t 54bank/post-harvest-loss-tracker-go .
docker run -p 6379:6379 54bank/post-harvest-loss-tracker-go
```
