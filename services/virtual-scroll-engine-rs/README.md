...
54Bank Virtual Scroll Engine service
...
# Run
PORT=8080 ./target/release/virtual-scroll-engine-rs
```
...
```bash
docker build -t 54bank/virtual-scroll-engine-rs .
docker run -p 8080:8080 54bank/virtual-scroll-engine-rs
```
