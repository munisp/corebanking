...
54Bank Typology Detector service
...
# Run
PORT=8080 ./target/release/typology-detector-rs
```
...
```bash
docker build -t 54bank/typology-detector-rs .
docker run -p 8080:8080 54bank/typology-detector-rs
```
