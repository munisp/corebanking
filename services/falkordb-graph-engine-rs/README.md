...
54Bank Falkordb Graph Engine service
...
# Run
PORT=8080 ./target/release/falkordb-graph-engine-rs
```
...
```bash
docker build -t 54bank/falkordb-graph-engine-rs .
docker run -p 8080:8080 54bank/falkordb-graph-engine-rs
```
