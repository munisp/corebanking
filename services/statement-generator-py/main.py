...
"""
statement-generator-py — Production-hardened service
"""
import os
import sys
import json
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            self._json(200, {"service": "statement-generator-py", **_degrade.status()})
        elif path == "/v1/alerts":
            ...
            if err:
                ...
                return
            items, total = db_query("statement_generator_py")
