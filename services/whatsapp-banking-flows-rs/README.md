...
54Bank Whatsapp Banking Flows service
...
# Run
PORT=8080 ./target/release/whatsapp-banking-flows-rs
```
...
```bash
docker build -t 54bank/whatsapp-banking-flows-rs .
docker run -p 8080:8080 54bank/whatsapp-banking-flows-rs
```
