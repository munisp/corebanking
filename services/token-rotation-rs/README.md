...
# Run
PORT=8080 ./target/release/token-rotation-rs
```
...
```bash
docker build -t 54bank/token-rotation-rs .
docker run -p 8080:8080 54bank/token-rotation-rs
```
