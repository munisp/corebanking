...
54Bank Payments Hub service

## Quick Start

```bash
# Build
go build -o payments-hub-go .

# Run
PORT=8100 ./payments-hub-go
```
...
```bash
docker build -t 54bank/payments-hub-go .
docker run -p 8100:8100 54bank/payments-hub-go
```
