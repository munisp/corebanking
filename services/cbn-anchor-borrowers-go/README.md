...
```bash
# Build
go build -o cbn-anchor-borrowers-go .

# Run
PORT=6379 ./cbn-anchor-borrowers-go
```
...
```bash
docker build -t 54bank/cbn-anchor-borrowers-go .
docker run -p 6379:6379 54bank/cbn-anchor-borrowers-go
```
