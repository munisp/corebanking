...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[efass-generator-rs] database connected, schema initialized");
    ...
    log::info!("[efass-generator-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
        keycloak_url, kafka_brokers, redis_url, opensearch_url, permify_url);

    let port: u16 = env::var("PORT").unwrap_or_else(|_| "8671".to_string()).parse().unwrap_or(8671);
