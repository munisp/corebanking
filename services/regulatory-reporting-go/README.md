...
```bash
# Build
go build -o regulatory-reporting-go .

# Run
PORT=6379 ./regulatory-reporting-go
```
...
```bash
docker build -t 54bank/regulatory-reporting-go .
docker run -p 6379:6379 54bank/regulatory-reporting-go
```
