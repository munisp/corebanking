...
54Bank Watchlist Manager service
...
# Run
PORT=8080 ./target/release/watchlist-manager-rs
```
...
```bash
docker build -t 54bank/watchlist-manager-rs .
docker run -p 8080:8080 54bank/watchlist-manager-rs
```
