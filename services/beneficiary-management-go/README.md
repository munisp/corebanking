...
```bash
# Build
go build -o beneficiary-management-go .

# Run
PORT=6379 ./beneficiary-management-go
```
...
```bash
docker build -t 54bank/beneficiary-management-go .
docker run -p 6379:6379 54bank/beneficiary-management-go
```
