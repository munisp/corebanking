...
54Bank Circuit Breaker service
...
# Run
PORT=8260 ./target/release/circuit-breaker-rs
```
...
```bash
docker build -t 54bank/circuit-breaker-rs .
docker run -p 8260:8260 54bank/circuit-breaker-rs
```
