...
54Bank Redis Cache Middleware service
...
# Run
PORT=8080 ./target/release/redis-cache-middleware-rs
```
...
```bash
docker build -t 54bank/redis-cache-middleware-rs .
docker run -p 8080:8080 54bank/redis-cache-middleware-rs
```
