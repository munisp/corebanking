...
```bash
# Build
go build -o banking-domain-integration-go .

# Run
PORT=4209 ./banking-domain-integration-go
```
...
```bash
docker build -t 54bank/banking-domain-integration-go .
docker run -p 4209:4209 54bank/banking-domain-integration-go
```
