...
class CBNTopics:
    REPORT = "cbn.report"
    NOTIFICATION = "cbn.notification"

class CBNEventTypes:
    REPORT_CREATED = "cbn.report.created"
    REPORT_UPDATED = "cbn.report.updated"
    REPORT_DELETED = "cbn.report.deleted"
...
class KafkaClient:
    ...
    def publish_report_event(self, event_type: str, report_id: str, tenant_id: str, status: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
        ...
        return self.publish_event(CBNTopics.REPORT, event, key=str(report_id))
