...
```bash
# Build
go build -o cooperative-meetings-go .

# Run
PORT=6379 ./cooperative-meetings-go
```
...
```bash
docker build -t 54bank/cooperative-meetings-go .
docker run -p 6379:6379 54bank/cooperative-meetings-go
```
