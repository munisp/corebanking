...
# Run
PORT=8099 ./target/release/operations-control-gl-rs
```
...
```bash
docker build -t 54bank/operations-control-gl-rs .
docker run -p 8099:8099 54bank/operations-control-gl-rs
```
