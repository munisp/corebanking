...
# Run
PORT=8080 ./target/release/bulk-payments-rs
```
...
```bash
docker build -t 54bank/bulk-payments-rs .
docker run -p 8080:8080 54bank/bulk-payments-rs
```
