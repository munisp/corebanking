...
54Bank Falkordb Coa service

## Quick Start

```bash
# Build
go build -o falkordb-coa-go .

# Run
PORT=8080 ./falkordb-coa-go
```
...
```bash
docker build -t 54bank/falkordb-coa-go .
docker run -p 8080:8080 54bank/falkordb-coa-go
```
