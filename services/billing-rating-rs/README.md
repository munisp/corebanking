...
# Run
PORT=8080 ./target/release/billing-rating-rs
```
...
```bash
docker build -t 54bank/billing-rating-rs .
docker run -p 8080:8080 54bank/billing-rating-rs
```
