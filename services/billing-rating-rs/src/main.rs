...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[billing-rating-rs] starting");

    let db_name = "billing-rating-rs".replace("-", "_");
    ...
    log::info!("[billing-rating-rs] database connected, schema initialized");
    ...
    log::info!("[billing-rating-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[billing-rating-rs] ready on :{}", port);
