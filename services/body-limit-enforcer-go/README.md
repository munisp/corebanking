...
```bash
# Build
go build -o body-limit-enforcer-go .

# Run
PORT=6379 ./body-limit-enforcer-go
```
...
```bash
docker build -t 54bank/body-limit-enforcer-go .
docker run -p 6379:6379 54bank/body-limit-enforcer-go
```
