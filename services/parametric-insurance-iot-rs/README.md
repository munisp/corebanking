# Parametric Insurance Iot

54Bank Parametric Insurance Iot service
...
# Run
PORT=8080 ./target/release/parametric-insurance-iot-rs
```
...
```bash
docker build -t 54bank/parametric-insurance-iot-rs .
docker run -p 8080:8080 54bank/parametric-insurance-iot-rs
```
