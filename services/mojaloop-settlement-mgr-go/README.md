...
```bash
# Build
go build -o mojaloop-settlement-mgr-go .

# Run
PORT=6379 ./mojaloop-settlement-mgr-go
```
...
```bash
docker build -t 54bank/mojaloop-settlement-mgr-go .
docker run -p 6379:6379 54bank/mojaloop-settlement-mgr-go
```
