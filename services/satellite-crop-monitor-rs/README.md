...
54Bank Satellite Crop Monitor service
...
# Run
PORT=8080 ./target/release/satellite-crop-monitor-rs
```
...
```bash
docker build -t 54bank/satellite-crop-monitor-rs .
docker run -p 8080:8080 54bank/satellite-crop-monitor-rs
```
