...
54Bank Waf Rules Engine service
...
# Run
PORT=8080 ./target/release/waf-rules-engine-rs
```
...
```bash
docker build -t 54bank/waf-rules-engine-rs .
docker run -p 8080:8080 54bank/waf-rules-engine-rs
```
