...
54Bank Session Security service
...
# Run
PORT=8080 ./target/release/session-security-rs
```
...
```bash
docker build -t 54bank/session-security-rs .
docker run -p 8080:8080 54bank/session-security-rs
```
