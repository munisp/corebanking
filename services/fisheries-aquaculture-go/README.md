...
```bash
# Build
go build -o fisheries-aquaculture-go .

# Run
PORT=6379 ./fisheries-aquaculture-go
```
...
```bash
docker build -t 54bank/fisheries-aquaculture-go .
docker run -p 6379:6379 54bank/fisheries-aquaculture-go
```
