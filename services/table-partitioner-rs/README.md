...
54Bank Table Partitioner service
...
# Run
PORT=8080 ./target/release/table-partitioner-rs
```
...
```bash
docker build -t 54bank/table-partitioner-rs .
docker run -p 8080:8080 54bank/table-partitioner-rs
```
