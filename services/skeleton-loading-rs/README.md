...
54Bank Skeleton Loading service
...
# Run
PORT=8080 ./target/release/skeleton-loading-rs
```
...
```bash
docker build -t 54bank/skeleton-loading-rs .
docker run -p 8080:8080 54bank/skeleton-loading-rs
```
