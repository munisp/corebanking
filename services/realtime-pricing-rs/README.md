...
54Bank Realtime Pricing service
...
# Run
PORT=8080 ./target/release/realtime-pricing-rs
```
...
```bash
docker build -t 54bank/realtime-pricing-rs .
docker run -p 8080:8080 54bank/realtime-pricing-rs
```
