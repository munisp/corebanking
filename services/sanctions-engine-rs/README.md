...
# Run
PORT=8121 ./target/release/sanctions-engine-rs
```
...
```bash
docker build -t 54bank/sanctions-engine-rs .
docker run -p 8121:8121 54bank/sanctions-engine-rs
```
