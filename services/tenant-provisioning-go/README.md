...
```bash
# Build
go build -o tenant-provisioning-go .

# Run
PORT=6379 ./tenant-provisioning-go
```
...
```bash
docker build -t 54bank/tenant-provisioning-go .
docker run -p 6379:6379 54bank/tenant-provisioning-go
```
