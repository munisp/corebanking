...
fn init_data_flow() -> EventBus {
    ...
    eprintln!("[continuous-liveness] Data flow initialized: topic=identity.verification");
    bus
}
...
mod tests {
    ...
    fn test_service_config() {
        ...
        assert!(true, "continuous-liveness-rs service module loads");
    }
    ...
    fn test_eventbus_creation() {
        let bus = EventBus::new("test.topic", "continuous_liveness");
        assert_eq!(bus.topic, "test.topic");
        assert_eq!(bus.service_name, "continuous_liveness");
    }
