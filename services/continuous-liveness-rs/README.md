...
54Bank Continuous Liveness service
...
# Run
PORT=8232 ./target/release/continuous-liveness-rs
```
...
```bash
docker build -t 54bank/continuous-liveness-rs .
docker run -p 8232:8232 54bank/continuous-liveness-rs
```
