...
```bash
# Build
go build -o corporate-monitoring-go .

# Run
PORT=6379 ./corporate-monitoring-go
```
...
```bash
docker build -t 54bank/corporate-monitoring-go .
docker run -p 6379:6379 54bank/corporate-monitoring-go
```
