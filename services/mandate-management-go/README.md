...
```bash
# Build
go build -o mandate-management-go .

# Run
PORT=6379 ./mandate-management-go
```
...
```bash
docker build -t 54bank/mandate-management-go .
docker run -p 6379:6379 54bank/mandate-management-go
```
