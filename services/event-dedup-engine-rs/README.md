...
54Bank Event Dedup Engine service
...
# Run
PORT=8080 ./target/release/event-dedup-engine-rs
```
...
```bash
docker build -t 54bank/event-dedup-engine-rs .
docker run -p 8080:8080 54bank/event-dedup-engine-rs
```
