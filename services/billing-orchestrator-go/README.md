...
```bash
# Build
go build -o billing-orchestrator-go .

# Run
PORT=6379 ./billing-orchestrator-go
```
...
```bash
docker build -t 54bank/billing-orchestrator-go .
docker run -p 6379:6379 54bank/billing-orchestrator-go
```
