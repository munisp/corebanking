...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[lakehouse-rs] starting");

    let db_name = "lakehouse-rs".replace("-", "_");
    ...
    log::info!("[lakehouse-rs] database connected, schema initialized");
    ...
    log::info!("[lakehouse-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[lakehouse-rs] ready on :{}", port);
