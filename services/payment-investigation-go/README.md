...
```bash
# Build
go build -o payment-investigation-go .

# Run
PORT=6379 ./payment-investigation-go
```
...
```bash
docker build -t 54bank/payment-investigation-go .
docker run -p 6379:6379 54bank/payment-investigation-go
```
