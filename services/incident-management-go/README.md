...
54Bank Incident Management service

## Quick Start

```bash
# Build
go build -o incident-management-go .

# Run
PORT=8100 ./incident-management-go
```
...
```bash
docker build -t 54bank/incident-management-go .
docker run -p 8100:8100 54bank/incident-management-go
```
