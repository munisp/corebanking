...
54Bank Contingent Liabilities service
...
# Run
PORT=8080 ./target/release/contingent-liabilities-rs
```
...
```bash
docker build -t 54bank/contingent-liabilities-rs .
docker run -p 8080:8080 54bank/contingent-liabilities-rs
```
