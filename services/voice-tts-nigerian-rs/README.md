...
54Bank Voice Tts Nigerian service
...
# Run
PORT=8080 ./target/release/voice-tts-nigerian-rs
```
...
```bash
docker build -t 54bank/voice-tts-nigerian-rs .
docker run -p 8080:8080 54bank/voice-tts-nigerian-rs
```
