# Tigerbeetle Multicurrency

54Bank Tigerbeetle Multicurrency service
...
# Run
PORT=8080 ./target/release/tigerbeetle-multicurrency-rs
```
...
```bash
docker build -t 54bank/tigerbeetle-multicurrency-rs .
docker run -p 8080:8080 54bank/tigerbeetle-multicurrency-rs
```
