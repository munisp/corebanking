...
# Run
PORT=8080 ./target/release/biometric-auth-rs
```
...
```bash
docker build -t 54bank/biometric-auth-rs .
docker run -p 8080:8080 54bank/biometric-auth-rs
```
