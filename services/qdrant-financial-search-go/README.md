# Qdrant Financial Search

54Bank Qdrant Financial Search service

## Quick Start

```bash
# Build
go build -o qdrant-financial-search-go .

# Run
PORT=8080 ./qdrant-financial-search-go
```
...
```bash
docker build -t 54bank/qdrant-financial-search-go .
docker run -p 8080:8080 54bank/qdrant-financial-search-go
```
