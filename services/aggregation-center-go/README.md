...
```bash
# Build
go build -o aggregation-center-go .

# Run
PORT=6379 ./aggregation-center-go
```
...
```bash
docker build -t 54bank/aggregation-center-go .
docker run -p 6379:6379 54bank/aggregation-center-go
```
