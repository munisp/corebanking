...
54Bank Relationship Pricing service
...
# Run
PORT=8080 ./target/release/relationship-pricing-rs
```
...
```bash
docker build -t 54bank/relationship-pricing-rs .
docker run -p 8080:8080 54bank/relationship-pricing-rs
```
