...
54Bank Realtime Gateway service

## Quick Start

```bash
# Build
go build -o realtime-gateway-go .

# Run
PORT=8096 ./realtime-gateway-go
```
...
```bash
docker build -t 54bank/realtime-gateway-go .
docker run -p 8096:8096 54bank/realtime-gateway-go
```
