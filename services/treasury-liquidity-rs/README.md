...
54Bank Treasury Liquidity service
...
# Run
PORT=8080 ./target/release/treasury-liquidity-rs
```
...
```bash
docker build -t 54bank/treasury-liquidity-rs .
docker run -p 8080:8080 54bank/treasury-liquidity-rs
```
