...
54Bank Sanctions Screening service
...
# Run
PORT=8080 ./target/release/sanctions-screening-rs
```
...
```bash
docker build -t 54bank/sanctions-screening-rs .
docker run -p 8080:8080 54bank/sanctions-screening-rs
```
