...
SERVICE_NAME = "opensearch-optimizer-py"
records: list = []
audit_log: list = []
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            ...
            self.respond(200, {"service": "opensearch-optimizer-py", **_degrade.status()})
        elif path == "/v1/alerts":
...
def delete_record(record_id: str):
    ...
    def do_POST(self):
        ...
        if path == "/v1/create":
            ...
            cache_set(f"opensearch-optimizer-py:last_post", str(body))
