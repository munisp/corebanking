...
class ExternalAPIClient:
    ...
    def _post(
        self, endpoint: str, data: Any | None = None, headers: dict | None = None, get_response: bool = True, files: dict | None = None
    ):
        """
        ...
        response = requests.post(url, json=json_data, data=str_data, files=files, headers=merged_headers, timeout=30)
