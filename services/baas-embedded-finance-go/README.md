...
54Bank Baas Embedded Finance service

## Quick Start

```bash
# Build
go build -o baas-embedded-finance-go .

# Run
PORT=8100 ./baas-embedded-finance-go
```
...
```bash
docker build -t 54bank/baas-embedded-finance-go .
docker run -p 8100:8100 54bank/baas-embedded-finance-go
```
