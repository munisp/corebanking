...
54Bank Livestock Management service
...
# Run
PORT=8080 ./target/release/livestock-management-rs
```
...
```bash
docker build -t 54bank/livestock-management-rs .
docker run -p 8080:8080 54bank/livestock-management-rs
```
