...
54Bank Open Banking Gateway service

## Quick Start

```bash
# Build
go build -o open-banking-gateway-go .

# Run
PORT=8100 ./open-banking-gateway-go
```
...
```bash
docker build -t 54bank/open-banking-gateway-go .
docker run -p 8100:8100 54bank/open-banking-gateway-go
```
