...
54Bank Fx Rates Engine service
...
# Run
PORT=8080 ./target/release/fx-rates-engine-rs
```
...
```bash
docker build -t 54bank/fx-rates-engine-rs .
docker run -p 8080:8080 54bank/fx-rates-engine-rs
```
