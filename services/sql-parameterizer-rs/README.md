...
54Bank Sql Parameterizer service
...
# Run
PORT=8080 ./target/release/sql-parameterizer-rs
```
...
```bash
docker build -t 54bank/sql-parameterizer-rs .
docker run -p 8080:8080 54bank/sql-parameterizer-rs
```
