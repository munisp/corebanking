...
```bash
# Build
go build -o aml-training-tracker-go .

# Run
PORT=6379 ./aml-training-tracker-go
```
...
```bash
docker build -t 54bank/aml-training-tracker-go .
docker run -p 6379:6379 54bank/aml-training-tracker-go
```
