...
```bash
# Build
go build -o whatsapp-business-gateway-go .

# Run
PORT=6379 ./whatsapp-business-gateway-go
```
...
```bash
docker build -t 54bank/whatsapp-business-gateway-go .
docker run -p 6379:6379 54bank/whatsapp-business-gateway-go
```
