...
```bash
# Build
go build -o optimistic-ui-engine-go .

# Run
PORT=6379 ./optimistic-ui-engine-go
```
...
```bash
docker build -t 54bank/optimistic-ui-engine-go .
docker run -p 6379:6379 54bank/optimistic-ui-engine-go
```
