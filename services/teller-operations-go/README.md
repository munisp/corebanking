...
```bash
# Build
go build -o teller-operations-go .

# Run
PORT=6379 ./teller-operations-go
```
...
```bash
docker build -t 54bank/teller-operations-go .
docker run -p 6379:6379 54bank/teller-operations-go
```
