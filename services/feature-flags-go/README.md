...
54Bank Feature Flags service

## Quick Start

```bash
# Build
go build -o feature-flags-go .

# Run
PORT=8097 ./feature-flags-go
```
...
```bash
docker build -t 54bank/feature-flags-go .
docker run -p 8097:8097 54bank/feature-flags-go
```
