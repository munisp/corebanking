...
54Bank Kafka Batch Producer service
...
# Run
PORT=8080 ./target/release/kafka-batch-producer-rs
```
...
```bash
docker build -t 54bank/kafka-batch-producer-rs .
docker run -p 8080:8080 54bank/kafka-batch-producer-rs
```
