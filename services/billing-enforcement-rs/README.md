...
# Run
PORT=8108 ./target/release/billing-enforcement-rs
```
...
```bash
docker build -t 54bank/billing-enforcement-rs .
docker run -p 8108:8108 54bank/billing-enforcement-rs
```
