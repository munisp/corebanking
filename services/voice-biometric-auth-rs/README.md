...
54Bank Voice Biometric Auth service
...
# Run
PORT=8080 ./target/release/voice-biometric-auth-rs
```
...
```bash
docker build -t 54bank/voice-biometric-auth-rs .
docker run -p 8080:8080 54bank/voice-biometric-auth-rs
```
