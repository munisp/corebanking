...
# Run
PORT=8080 ./target/release/path-validator-rs
```
...
```bash
docker build -t 54bank/path-validator-rs .
docker run -p 8080:8080 54bank/path-validator-rs
```
