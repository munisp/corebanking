...
# Run
PORT=8080 ./target/release/auth-enforcer-rs
```
...
```bash
docker build -t 54bank/auth-enforcer-rs .
docker run -p 8080:8080 54bank/auth-enforcer-rs
```
