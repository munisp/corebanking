...
54Bank Feature Flag Engine service
...
# Run
PORT=8080 ./target/release/feature-flag-engine-rs
```
...
```bash
docker build -t 54bank/feature-flag-engine-rs .
docker run -p 8080:8080 54bank/feature-flag-engine-rs
```
