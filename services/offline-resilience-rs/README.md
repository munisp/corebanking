...
54Bank Offline Resilience service
...
# Run
PORT=8080 ./target/release/offline-resilience-rs
```
...
```bash
docker build -t 54bank/offline-resilience-rs .
docker run -p 8080:8080 54bank/offline-resilience-rs
```
