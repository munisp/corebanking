...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[falkordb-graph-rs] starting");

    let db_name = "falkordb-graph-rs".replace("-", "_");
    ...
    log::info!("[falkordb-graph-rs] database connected, schema initialized");
    ...
    log::info!("[falkordb-graph-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[falkordb-graph-rs] ready on :{}", port);
