...
# Run
PORT=8080 ./target/release/falkordb-graph-rs
```
...
```bash
docker build -t 54bank/falkordb-graph-rs .
docker run -p 8080:8080 54bank/falkordb-graph-rs
```
