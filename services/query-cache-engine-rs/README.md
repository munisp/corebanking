...
54Bank Query Cache Engine service
...
# Run
PORT=8080 ./target/release/query-cache-engine-rs
```
...
```bash
docker build -t 54bank/query-cache-engine-rs .
docker run -p 8080:8080 54bank/query-cache-engine-rs
```
