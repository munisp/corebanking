...
54Bank Bloom Filter Cache service
...
# Run
PORT=8080 ./target/release/bloom-filter-cache-rs
```
...
```bash
docker build -t 54bank/bloom-filter-cache-rs .
docker run -p 8080:8080 54bank/bloom-filter-cache-rs
```
