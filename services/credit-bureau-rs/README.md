...
# Run
PORT=8080 ./target/release/credit-bureau-rs
```
...
```bash
docker build -t 54bank/credit-bureau-rs .
docker run -p 8080:8080 54bank/credit-bureau-rs
```
