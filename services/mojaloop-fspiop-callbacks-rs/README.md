...
54Bank Mojaloop Fspiop Callbacks service
...
# Run
PORT=8080 ./target/release/mojaloop-fspiop-callbacks-rs
```
...
```bash
docker build -t 54bank/mojaloop-fspiop-callbacks-rs .
docker run -p 8080:8080 54bank/mojaloop-fspiop-callbacks-rs
```
