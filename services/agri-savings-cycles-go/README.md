...
```bash
# Build
go build -o agri-savings-cycles-go .

# Run
PORT=6379 ./agri-savings-cycles-go
```
...
```bash
docker build -t 54bank/agri-savings-cycles-go .
docker run -p 6379:6379 54bank/agri-savings-cycles-go
```
