...
```bash
# Build
go build -o incident-responder-go .

# Run
PORT=6379 ./incident-responder-go
```
...
```bash
docker build -t 54bank/incident-responder-go .
docker run -p 6379:6379 54bank/incident-responder-go
```
