...
"""
voice-nlu-banking-py — Production-hardened service
"""
import os
import sys
import json
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            if err:
                ...
                return
            items, total = db_query("voice_nlu_banking_py")
    ...
    def do_POST(self):
        ...
        if path == "/v1/create":
            ...
            _event_bus.emit("voice-nlu-banking.processed", {"action": "process", "status": "success"})
...
_event_bus = EventBus("platform.events", "voice-nlu-banking")

if __name__ == "__main__":
    get_db()
    server = HTTPServer(("0.0.0.0", PORT), Handler)
    logger.info(json.dumps({"service": "voice-nlu-banking-py", "port": PORT, "message": "starting"}))
    try:
