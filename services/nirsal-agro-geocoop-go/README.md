...
```bash
# Build
go build -o nirsal-agro-geocoop-go .

# Run
PORT=6379 ./nirsal-agro-geocoop-go
```
...
```bash
docker build -t 54bank/nirsal-agro-geocoop-go .
docker run -p 6379:6379 54bank/nirsal-agro-geocoop-go
```
