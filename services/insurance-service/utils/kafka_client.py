...
class InsuranceTopics:
    POLICY = "insurance.policy"
    CLAIM = "insurance.claim"

class InsuranceEventTypes:
...
class KafkaClient:
    ...
    def publish_policy_event(self, event_type: str, policy_id: str, tenant_id: str, status: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
        event = {
            "type": event_type,
            "policy_id": policy_id,
            "tenant_id": tenant_id,
        ...
        return self.publish_event(InsuranceTopics.POLICY, event, key=str(policy_id))
