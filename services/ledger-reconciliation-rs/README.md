...
54Bank Ledger Reconciliation service
...
# Run
PORT=8080 ./target/release/ledger-reconciliation-rs
```
...
```bash
docker build -t 54bank/ledger-reconciliation-rs .
docker run -p 8080:8080 54bank/ledger-reconciliation-rs
```
