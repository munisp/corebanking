...
class DisputeTopics:
    ...
    NOTIFICATION = "dispute.notification"

class DisputeEventTypes:
...
class KafkaClient:
    ...
    def publish_dispute_event(self, event_type: str, dispute_id: str, tenant_id: str, status: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
        event = {
            "type": event_type,
        ...
        return self.publish_event(DisputeTopics.DISPUTE, event, key=str(dispute_id))
