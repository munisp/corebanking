...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            self._json(200, {"service": "agent-reconciliation-py", **_degrade.status()})
        elif path == "/v1/alerts":
    ...
    def do_POST(self):
        ...
        if path == "/v1/agent/reconcile":
            ...
            _event_bus.emit("agent-reconciliation.processed", {"action": "process", "status": "success"})
...
_event_bus = EventBus("platform.events", "agent-reconciliation")
