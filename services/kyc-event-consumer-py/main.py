...
# --- Domain state: KYC event-trigger rules and runtime counters ---
TRIGGER_RULES = [
    {"topic": "transactions.high-value", "event": "kyc_refresh", "cooldown_hours": 24, "kyc_level": 2, "services": ["kyc-engine"]},
    {"topic": "accounts.dormant-reactivation", "event": "kyc_reverify", "cooldown_hours": 72, "kyc_level": 2, "services": ["kyc-engine"]},
    {"topic": "loans.application", "event": "kyb_screen", "cooldown_hours": 12, "kyc_level": 3, "services": ["kyc-engine", "aml-screening"]},
]
