...
54Bank Farm Boundary Mapping service
...
# Run
PORT=8080 ./target/release/farm-boundary-mapping-rs
```
...
```bash
docker build -t 54bank/farm-boundary-mapping-rs .
docker run -p 8080:8080 54bank/farm-boundary-mapping-rs
```
