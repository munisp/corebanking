...
54Bank Graduated Rollout service
...
# Run
PORT=8080 ./target/release/graduated-rollout-rs
```
...
```bash
docker build -t 54bank/graduated-rollout-rs .
docker run -p 8080:8080 54bank/graduated-rollout-rs
```
