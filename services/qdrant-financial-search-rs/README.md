...
# Run
PORT=8080 ./target/release/qdrant-financial-search-rs
```
...
```bash
docker build -t 54bank/qdrant-financial-search-rs .
docker run -p 8080:8080 54bank/qdrant-financial-search-rs
```
