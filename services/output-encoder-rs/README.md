...
# Run
PORT=8080 ./target/release/output-encoder-rs
```
...
```bash
docker build -t 54bank/output-encoder-rs .
docker run -p 8080:8080 54bank/output-encoder-rs
```
