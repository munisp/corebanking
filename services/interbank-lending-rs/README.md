...
54Bank Interbank Lending service
...
# Run
PORT=8080 ./target/release/interbank-lending-rs
```
...
```bash
docker build -t 54bank/interbank-lending-rs .
docker run -p 8080:8080 54bank/interbank-lending-rs
```
