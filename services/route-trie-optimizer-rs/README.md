# Route Trie Optimizer

54Bank Route Trie Optimizer service
...
# Run
PORT=8080 ./target/release/route-trie-optimizer-rs
```
...
```bash
docker build -t 54bank/route-trie-optimizer-rs .
docker run -p 8080:8080 54bank/route-trie-optimizer-rs
```
