...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[route-trie-optimizer-rs] starting");

    let db_name = "route-trie-optimizer-rs".replace("-", "_");
    ...
    log::info!("[route-trie-optimizer-rs] database connected, schema initialized");
    ...
    log::info!("[route-trie-optimizer-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[route-trie-optimizer-rs] ready on :{}", port);
