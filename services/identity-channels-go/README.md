...
```bash
# Build
go build -o identity-channels-go .

# Run
PORT=6379 ./identity-channels-go
```
...
```bash
docker build -t 54bank/identity-channels-go .
docker run -p 6379:6379 54bank/identity-channels-go
```
