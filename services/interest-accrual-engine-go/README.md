...
54Bank Interest Accrual Engine service

## Quick Start

```bash
# Build
go build -o interest-accrual-engine-go .

# Run
PORT=8094 ./interest-accrual-engine-go
```
...
```bash
docker build -t 54bank/interest-accrual-engine-go .
docker run -p 8094:8094 54bank/interest-accrual-engine-go
```
