...
```bash
# Build
go build -o voice-banking-gateway-go .

# Run
PORT=6379 ./voice-banking-gateway-go
```
...
```bash
docker build -t 54bank/voice-banking-gateway-go .
docker run -p 6379:6379 54bank/voice-banking-gateway-go
```
