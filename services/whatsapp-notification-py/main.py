...
"""
whatsapp-notification-py — Production-hardened service
"""
import os
import sys
import json
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            if err:
                ...
                return
            items, total = db_query("whatsapp_notification_py")
    ...
    def do_POST(self):
        ...
        if path == "/v1/create":
            ...
            _event_bus.emit("whatsapp-notification.processed", {"action": "process", "status": "success"})
...
_event_bus = EventBus("notifications.delivery", "whatsapp-notification")

if __name__ == "__main__":
    get_db()
    server = HTTPServer(("0.0.0.0", PORT), Handler)
    logger.info(json.dumps({"service": "whatsapp-notification-py", "port": PORT, "message": "starting"}))
    try:
