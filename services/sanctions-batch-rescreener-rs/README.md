...
54Bank Sanctions Batch Rescreener service
...
# Run
PORT=8080 ./target/release/sanctions-batch-rescreener-rs
```
...
```bash
docker build -t 54bank/sanctions-batch-rescreener-rs .
docker run -p 8080:8080 54bank/sanctions-batch-rescreener-rs
```
