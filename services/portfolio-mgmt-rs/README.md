...
# Run
PORT=8080 ./target/release/portfolio-mgmt-rs
```
...
```bash
docker build -t 54bank/portfolio-mgmt-rs .
docker run -p 8080:8080 54bank/portfolio-mgmt-rs
```
