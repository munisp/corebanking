...
```bash
# Build
go build -o supply-chain-finance-go .

# Run
PORT=6379 ./supply-chain-finance-go
```
...
```bash
docker build -t 54bank/supply-chain-finance-go .
docker run -p 6379:6379 54bank/supply-chain-finance-go
```
