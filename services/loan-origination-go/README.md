...
54Bank Loan Origination service

## Quick Start

```bash
# Build
go build -o loan-origination-go .

# Run
PORT=8099 ./loan-origination-go
```
...
```bash
docker build -t 54bank/loan-origination-go .
docker run -p 8099:8099 54bank/loan-origination-go
```
