# Fluvio Wasm Transform

54Bank Fluvio Wasm Transform service
...
# Run
PORT=8080 ./target/release/fluvio-wasm-transform-rs
```
...
```bash
docker build -t 54bank/fluvio-wasm-transform-rs .
docker run -p 8080:8080 54bank/fluvio-wasm-transform-rs
```
