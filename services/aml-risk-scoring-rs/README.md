...
54Bank Aml Risk Scoring service
...
# Run
PORT=8080 ./target/release/aml-risk-scoring-rs
```
...
```bash
docker build -t 54bank/aml-risk-scoring-rs .
docker run -p 8080:8080 54bank/aml-risk-scoring-rs
```
