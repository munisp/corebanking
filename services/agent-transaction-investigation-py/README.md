# Agent Transaction Investigation
...
```bash
docker build -t 54bank/agent-transaction-investigation-py .
docker run -p 8080:8080 54bank/agent-transaction-investigation-py
```
