...
54Bank Qdrant Vector Store service
...
# Run
PORT=8080 ./target/release/qdrant-vector-store-rs
```
...
```bash
docker build -t 54bank/qdrant-vector-store-rs .
docker run -p 8080:8080 54bank/qdrant-vector-store-rs
```
