...
54Bank Securities Trading service
...
# Run
PORT=8080 ./target/release/securities-trading-rs
```
...
```bash
docker build -t 54bank/securities-trading-rs .
docker run -p 8080:8080 54bank/securities-trading-rs
```
