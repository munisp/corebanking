...
```bash
# Build
go build -o salary-processing-go .

# Run
PORT=6379 ./salary-processing-go
```
...
```bash
docker build -t 54bank/salary-processing-go .
docker run -p 6379:6379 54bank/salary-processing-go
```
