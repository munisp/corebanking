...
```bash
# Build
go build -o notification-service-go .

# Run
PORT=6379 ./notification-service-go
```
...
```bash
docker build -t 54bank/notification-service-go .
docker run -p 6379:6379 54bank/notification-service-go
```
