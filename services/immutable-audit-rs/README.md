...
54Bank Immutable Audit service
...
# Run
PORT=8080 ./target/release/immutable-audit-rs
```
...
```bash
docker build -t 54bank/immutable-audit-rs .
docker run -p 8080:8080 54bank/immutable-audit-rs
```
