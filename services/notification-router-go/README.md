...
```bash
# Build
go build -o notification-router-go .

# Run
PORT=6379 ./notification-router-go
```
...
```bash
docker build -t 54bank/notification-router-go .
docker run -p 6379:6379 54bank/notification-router-go
```
