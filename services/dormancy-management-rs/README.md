...
54Bank Dormancy Management service
...
# Run
PORT=8080 ./target/release/dormancy-management-rs
```
...
```bash
docker build -t 54bank/dormancy-management-rs .
docker run -p 8080:8080 54bank/dormancy-management-rs
```
