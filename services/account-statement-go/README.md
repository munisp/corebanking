...
```bash
# Build
go build -o account-statement-go .

# Run
PORT=6379 ./account-statement-go
```
...
```bash
docker build -t 54bank/account-statement-go .
docker run -p 6379:6379 54bank/account-statement-go
```
