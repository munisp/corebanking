...
54Bank Sms Otp Service service
...
# Run
PORT=8080 ./target/release/sms-otp-service-rs
```
...
```bash
docker build -t 54bank/sms-otp-service-rs .
docker run -p 8080:8080 54bank/sms-otp-service-rs
```
