...
54Bank Cross Border Remittance service

## Quick Start

```bash
# Build
go build -o cross-border-remittance-go .

# Run
PORT=8100 ./cross-border-remittance-go
```
...
```bash
docker build -t 54bank/cross-border-remittance-go .
docker run -p 8100:8100 54bank/cross-border-remittance-go
```
