...
54Bank Express Rate Limiter service
...
# Run
PORT=8080 ./target/release/express-rate-limiter-rs
```
...
```bash
docker build -t 54bank/express-rate-limiter-rs .
docker run -p 8080:8080 54bank/express-rate-limiter-rs
```
