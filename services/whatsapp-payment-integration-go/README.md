...
```bash
# Build
go build -o whatsapp-payment-integration-go .

# Run
PORT=6379 ./whatsapp-payment-integration-go
```
...
```bash
docker build -t 54bank/whatsapp-payment-integration-go .
docker run -p 6379:6379 54bank/whatsapp-payment-integration-go
```
