...
```bash
# Build
go build -o multi-bureau-verification-go .

# Run
PORT=6379 ./multi-bureau-verification-go
```
...
```bash
docker build -t 54bank/multi-bureau-verification-go .
docker run -p 6379:6379 54bank/multi-bureau-verification-go
```
