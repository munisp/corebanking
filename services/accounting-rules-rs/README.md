...
54Bank Accounting Rules service
...
# Run
PORT=8080 ./target/release/accounting-rules-rs
```
...
```bash
docker build -t 54bank/accounting-rules-rs .
docker run -p 8080:8080 54bank/accounting-rules-rs
```
