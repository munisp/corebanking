...
```bash
# Build
go build -o identity-verification-go .

# Run
PORT=6379 ./identity-verification-go
```
...
```bash
docker build -t 54bank/identity-verification-go .
docker run -p 6379:6379 54bank/identity-verification-go
```
