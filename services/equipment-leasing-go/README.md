...
```bash
# Build
go build -o equipment-leasing-go .

# Run
PORT=6379 ./equipment-leasing-go
```
...
```bash
docker build -t 54bank/equipment-leasing-go .
docker run -p 6379:6379 54bank/equipment-leasing-go
```
