...
54Bank Tigerbeetle Ledger service
...
# Run
PORT=8080 ./target/release/tigerbeetle-ledger-rs
```
...
```bash
docker build -t 54bank/tigerbeetle-ledger-rs .
docker run -p 8080:8080 54bank/tigerbeetle-ledger-rs
```
