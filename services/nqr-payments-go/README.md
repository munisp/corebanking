...
54Bank Nqr Payments service

## Quick Start

```bash
# Build
go build -o nqr-payments-go .

# Run
PORT=8100 ./nqr-payments-go
```
...
```bash
docker build -t 54bank/nqr-payments-go .
docker run -p 8100:8100 54bank/nqr-payments-go
```
