"""
document-intelligence-py - Production-ready service with PostgreSQL persistence.
...
@app.get("/healthz")
def health():
    return {"status": "healthy", "service": "document-intelligence-py", "version": "1.0.0"}
...
def metrics():
    try:
        ...
        return {"service": "document-intelligence-py", "total_records": count}
    except Exception:
