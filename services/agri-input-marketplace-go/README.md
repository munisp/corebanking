...
```bash
# Build
go build -o agri-input-marketplace-go .

# Run
PORT=6379 ./agri-input-marketplace-go
```
...
```bash
docker build -t 54bank/agri-input-marketplace-go .
docker run -p 6379:6379 54bank/agri-input-marketplace-go
```
