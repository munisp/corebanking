...
54Bank Otc Derivatives service
...
# Run
PORT=8080 ./target/release/otc-derivatives-rs
```
...
```bash
docker build -t 54bank/otc-derivatives-rs .
docker run -p 8080:8080 54bank/otc-derivatives-rs
```
