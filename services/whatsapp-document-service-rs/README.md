...
54Bank Whatsapp Document Service service
...
# Run
PORT=8080 ./target/release/whatsapp-document-service-rs
```
...
```bash
docker build -t 54bank/whatsapp-document-service-rs .
docker run -p 8080:8080 54bank/whatsapp-document-service-rs
```
