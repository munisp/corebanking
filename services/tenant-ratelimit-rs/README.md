...
54Bank Tenant Ratelimit service
...
# Run
PORT=8080 ./target/release/tenant-ratelimit-rs
```
...
```bash
docker build -t 54bank/tenant-ratelimit-rs .
docker run -p 8080:8080 54bank/tenant-ratelimit-rs
```
