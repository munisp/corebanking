...
54Bank Livestock Insurance service
...
# Run
PORT=8080 ./target/release/livestock-insurance-rs
```
...
```bash
docker build -t 54bank/livestock-insurance-rs .
docker run -p 8080:8080 54bank/livestock-insurance-rs
```
