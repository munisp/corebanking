# Txn Monitoring Rules

54Bank Txn Monitoring Rules service
...
# Run
PORT=8080 ./target/release/txn-monitoring-rules-rs
```
...
```bash
docker build -t 54bank/txn-monitoring-rules-rs .
docker run -p 8080:8080 54bank/txn-monitoring-rules-rs
```
