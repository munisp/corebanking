...
54Bank Feature Entitlement service

## Quick Start

```bash
# Build
go build -o feature-entitlement-go .

# Run
PORT=8092 ./feature-entitlement-go
```
...
```bash
docker build -t 54bank/feature-entitlement-go .
docker run -p 8092:8092 54bank/feature-entitlement-go
```
