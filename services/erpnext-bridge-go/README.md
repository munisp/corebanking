...
54Bank Erpnext Bridge service

## Quick Start

```bash
# Build
go build -o erpnext-bridge-go .

# Run
PORT=8091 ./erpnext-bridge-go
```
...
```bash
docker build -t 54bank/erpnext-bridge-go .
docker run -p 8091:8091 54bank/erpnext-bridge-go
```
