...
54Bank Clickjack Defender service
...
# Run
PORT=8080 ./target/release/clickjack-defender-rs
```
...
```bash
docker build -t 54bank/clickjack-defender-rs .
docker run -p 8080:8080 54bank/clickjack-defender-rs
```
