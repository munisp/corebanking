...
54Bank Field Level Encryption service
...
# Run
PORT=8080 ./target/release/field-level-encryption-rs
```
...
```bash
docker build -t 54bank/field-level-encryption-rs .
docker run -p 8080:8080 54bank/field-level-encryption-rs
```
