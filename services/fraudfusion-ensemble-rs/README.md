...
54Bank Fraudfusion Ensemble service
...
# Run
PORT=8080 ./target/release/fraudfusion-ensemble-rs
```
...
```bash
docker build -t 54bank/fraudfusion-ensemble-rs .
docker run -p 8080:8080 54bank/fraudfusion-ensemble-rs
```
