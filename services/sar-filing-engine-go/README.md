...
```bash
# Build
go build -o sar-filing-engine-go .

# Run
PORT=6379 ./sar-filing-engine-go
```
...
```bash
docker build -t 54bank/sar-filing-engine-go .
docker run -p 6379:6379 54bank/sar-filing-engine-go
```
