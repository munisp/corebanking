...
54Bank Livestock Finance service
...
# Run
PORT=8080 ./target/release/livestock-finance-rs
```
...
```bash
docker build -t 54bank/livestock-finance-rs .
docker run -p 8080:8080 54bank/livestock-finance-rs
```
