...
54Bank Mojaloop Tb Bridge service
...
# Run
PORT=8080 ./target/release/mojaloop-tb-bridge-rs
```
...
```bash
docker build -t 54bank/mojaloop-tb-bridge-rs .
docker run -p 8080:8080 54bank/mojaloop-tb-bridge-rs
```
