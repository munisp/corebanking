...
```bash
# Build
go build -o bvn-nin-verification-go .

# Run
PORT=6379 ./bvn-nin-verification-go
```
...
```bash
docker build -t 54bank/bvn-nin-verification-go .
docker run -p 6379:6379 54bank/bvn-nin-verification-go
```
