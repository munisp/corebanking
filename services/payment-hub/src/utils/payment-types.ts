/**
 * Centralized Payment Type Definitions (TypeScript)
 * ================================================
 *
...
export class PaymentTypeHelper {
   ...
   * 
   * @param paymentType - String or PaymentType enum value
   * @returns Standardized PaymentType enum value
   * @throws Error if payment type is not recognized
   */
  static normalizePaymentType(paymentType: string | PaymentType): PaymentType {
    if (typeof paymentType === "string") {
      // Try enum value match (case-insensitive)
   ...
   * 
   * @returns PaymentTypeDirection.INCOMING, PaymentTypeDirection.OUTGOING, or null for bidirectional
   */
