...
# Run
PORT=8080 ./target/release/stress-testing-rs
```
...
```bash
docker build -t 54bank/stress-testing-rs .
docker run -p 8080:8080 54bank/stress-testing-rs
```
