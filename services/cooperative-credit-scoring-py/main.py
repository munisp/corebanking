    ...
    def do_POST(self):
        ...
        if err:
            ...
            try:
                ...
                call_service("POST", f"{_upstream}/v1/score", {"service": SERVICE_NAME, "action": "notify"})
