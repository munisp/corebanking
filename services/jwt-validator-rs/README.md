...
# Run
PORT=8080 ./target/release/jwt-validator-rs
```
...
```bash
docker build -t 54bank/jwt-validator-rs .
docker run -p 8080:8080 54bank/jwt-validator-rs
```
