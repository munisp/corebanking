...
54Bank Wire Transfer Monitor service
...
# Run
PORT=8080 ./target/release/wire-transfer-monitor-rs
```
...
```bash
docker build -t 54bank/wire-transfer-monitor-rs .
docker run -p 8080:8080 54bank/wire-transfer-monitor-rs
```
