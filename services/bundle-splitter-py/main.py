...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            self._json(200, {"service": "bundle-splitter-py", **_degrade.status()})
        elif path == "/v1/alerts":
