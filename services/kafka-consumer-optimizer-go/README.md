...
```bash
# Build
go build -o kafka-consumer-optimizer-go .

# Run
PORT=6379 ./kafka-consumer-optimizer-go
```
...
```bash
docker build -t 54bank/kafka-consumer-optimizer-go .
docker run -p 6379:6379 54bank/kafka-consumer-optimizer-go
```
