...
> Renamed from `ROLE_SYSTEM_QUICK_REF.py` — this file is documentation (with
> pasted TypeScript/Python snippets), not executable Python; the `.py`
> extension caused pyflakes F821 "undefined name" findings on the JS snippets.
