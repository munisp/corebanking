...
class AuthEventTypes:
    ...
    AUTH_PASSWORD_SETUP = "auth.password.setup"
...
class KafkaClient:
    ...
    def publish_auth_event(self, event_type: str, user_id: str, tenant_id: str, status: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
        event = {
            "type": event_type,
            "user_id": user_id,
            "tenant_id": tenant_id,
