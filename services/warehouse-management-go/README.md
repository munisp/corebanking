...
```bash
# Build
go build -o warehouse-management-go .

# Run
PORT=6379 ./warehouse-management-go
```
...
```bash
docker build -t 54bank/warehouse-management-go .
docker run -p 6379:6379 54bank/warehouse-management-go
```
