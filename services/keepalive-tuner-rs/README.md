...
54Bank Keepalive Tuner service
...
# Run
PORT=8080 ./target/release/keepalive-tuner-rs
```
...
```bash
docker build -t 54bank/keepalive-tuner-rs .
docker run -p 8080:8080 54bank/keepalive-tuner-rs
```
