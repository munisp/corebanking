...
# Run
PORT=8234 ./target/release/reconciliation-engine-rs
```
...
```bash
docker build -t 54bank/reconciliation-engine-rs .
docker run -p 8234:8234 54bank/reconciliation-engine-rs
```
