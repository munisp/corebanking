...
54Bank Egress Controller service
...
# Run
PORT=8080 ./target/release/egress-controller-rs
```
...
```bash
docker build -t 54bank/egress-controller-rs .
docker run -p 8080:8080 54bank/egress-controller-rs
```
