...
fn init_data_flow() -> EventBus {
    ...
    eprintln!("[egress-controller] Data flow initialized: topic=security.infra");
    bus
}
...
mod tests {
    ...
    fn test_service_config() {
        ...
        assert!(true, "egress-controller-rs service module loads");
    }
    ...
    fn test_eventbus_creation() {
        let bus = EventBus::new("test.topic", "egress_controller");
        assert_eq!(bus.topic, "test.topic");
        assert_eq!(bus.service_name, "egress_controller");
    }
