...
54Bank Interest Computation service
...
# Run
PORT=8080 ./target/release/interest-computation-rs
```
...
```bash
docker build -t 54bank/interest-computation-rs .
docker run -p 8080:8080 54bank/interest-computation-rs
```
