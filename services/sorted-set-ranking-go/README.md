...
```bash
# Build
go build -o sorted-set-ranking-go .

# Run
PORT=6379 ./sorted-set-ranking-go
```
...
```bash
docker build -t 54bank/sorted-set-ranking-go .
docker run -p 6379:6379 54bank/sorted-set-ranking-go
```
