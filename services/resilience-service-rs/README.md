...
54Bank Resilience Service service
...
# Run
PORT=8080 ./target/release/resilience-service-rs
```
...
```bash
docker build -t 54bank/resilience-service-rs .
docker run -p 8080:8080 54bank/resilience-service-rs
```
