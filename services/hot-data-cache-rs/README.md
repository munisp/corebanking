...
# Run
PORT=8080 ./target/release/hot-data-cache-rs
```
...
```bash
docker build -t 54bank/hot-data-cache-rs .
docker run -p 8080:8080 54bank/hot-data-cache-rs
```
