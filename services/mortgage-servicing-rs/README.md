...
54Bank Mortgage Servicing service
...
# Run
PORT=8080 ./target/release/mortgage-servicing-rs
```
...
```bash
docker build -t 54bank/mortgage-servicing-rs .
docker run -p 8080:8080 54bank/mortgage-servicing-rs
```
