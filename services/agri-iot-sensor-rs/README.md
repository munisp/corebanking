...
54Bank Agri Iot Sensor service
...
# Run
PORT=8080 ./target/release/agri-iot-sensor-rs
```
...
```bash
docker build -t 54bank/agri-iot-sensor-rs .
docker run -p 8080:8080 54bank/agri-iot-sensor-rs
```
