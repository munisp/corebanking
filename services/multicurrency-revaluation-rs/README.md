...
54Bank Multicurrency Revaluation service
...
# Run
PORT=8080 ./target/release/multicurrency-revaluation-rs
```
...
```bash
docker build -t 54bank/multicurrency-revaluation-rs .
docker run -p 8080:8080 54bank/multicurrency-revaluation-rs
```
