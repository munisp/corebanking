...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[neo4j-coa-graph-rs] database connected, schema initialized");
    ...
    log::info!("[neo4j-coa-graph-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[neo4j-coa-graph-rs] ready on :{}", port);
