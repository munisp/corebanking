...
54Bank Multi Peril Crop Insurance service
...
# Run
PORT=8080 ./target/release/multi-peril-crop-insurance-rs
```
...
```bash
docker build -t 54bank/multi-peril-crop-insurance-rs .
docker run -p 8080:8080 54bank/multi-peril-crop-insurance-rs
```
