...
```bash
# Build
go build -o quality-certification-go .

# Run
PORT=6379 ./quality-certification-go
```
...
```bash
docker build -t 54bank/quality-certification-go .
docker run -p 6379:6379 54bank/quality-certification-go
```
