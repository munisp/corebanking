...
54Bank Product Factory service
...
# Run
PORT=8080 ./target/release/product-factory-rs
```
...
```bash
docker build -t 54bank/product-factory-rs .
docker run -p 8080:8080 54bank/product-factory-rs
```
