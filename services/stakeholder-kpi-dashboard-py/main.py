...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/healthz":
            ...
            self.respond(200, {"service": "stakeholder-kpi-dashboard-py", **_degrade.status()})
        elif path == "/v1/alerts":
            ...
            self.end_headers()
            self.wfile.write(f'requests_total{{service="stakeholder-kpi-dashboard-py"}} {request_count}\nerrors_total{{service="stakeholder-kpi-dashboard-py"}} {error_count}\n'.encode())
