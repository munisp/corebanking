...
```bash
# Build
go build -o cooperative-management-go .

# Run
PORT=6379 ./cooperative-management-go
```
...
```bash
docker build -t 54bank/cooperative-management-go .
docker run -p 6379:6379 54bank/cooperative-management-go
```
