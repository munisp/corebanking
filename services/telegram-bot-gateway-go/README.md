...
```bash
# Build
go build -o telegram-bot-gateway-go .

# Run
PORT=6379 ./telegram-bot-gateway-go
```
...
```bash
docker build -t 54bank/telegram-bot-gateway-go .
docker run -p 6379:6379 54bank/telegram-bot-gateway-go
```
