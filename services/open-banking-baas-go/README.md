...
54Bank Open Banking Baas service

## Quick Start

```bash
# Build
go build -o open-banking-baas-go .

# Run
PORT=8095 ./open-banking-baas-go
```
...
```bash
docker build -t 54bank/open-banking-baas-go .
docker run -p 8095:8095 54bank/open-banking-baas-go
```
