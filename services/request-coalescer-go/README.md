...
```bash
# Build
go build -o request-coalescer-go .

# Run
PORT=6379 ./request-coalescer-go
```
...
```bash
docker build -t 54bank/request-coalescer-go .
docker run -p 6379:6379 54bank/request-coalescer-go
```
