...
#!/usr/bin/env python3
"""
batch-processing-py — 54Bank Microservice
...
if __name__ == "__main__":
    ...
    _threading.Thread(target=start_grpc_server, args=("batch-processing-py", 9200), daemon=True).start()
    try:
