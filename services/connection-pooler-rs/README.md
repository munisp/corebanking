...
54Bank Connection Pooler service
...
# Run
PORT=8080 ./target/release/connection-pooler-rs
```
...
```bash
docker build -t 54bank/connection-pooler-rs .
docker run -p 8080:8080 54bank/connection-pooler-rs
```
