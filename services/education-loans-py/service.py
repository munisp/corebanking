...
class Handler(BaseHTTPRequestHandler):
    ...
    def _disburse_loan(self, loan_id: str, body: dict):
        ...
        db_persist("disbursements", d.to_dict() if hasattr(d, "to_dict") else d if isinstance(d, dict) else {"value": str(d)})
    ...
    def _repay_loan(self, loan_id: str, body: dict):
        ...
        repayments.append(r)
        db_persist("repayments", r.to_dict() if hasattr(r, "to_dict") else r if isinstance(r, dict) else {"value": str(r)})
