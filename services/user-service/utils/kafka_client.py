...
# Event type constants for user lifecycle
...
class BufferedEvent:
    """Represents a buffered event waiting to be sent"""
...
class KafkaClient:
    ...
    def publish_user_event(
        ...
        return self.publish_event(UserTopics.USERS, event, key=str(user_id))
    ...
    def publish_auth_event(
        ...
        return self.publish_event(UserTopics.AUTH, event, key=user_id)
    ...
    def publish_audit_event(
        ...
        return self.publish_event(UserTopics.AUDIT, event, key=user_id)
