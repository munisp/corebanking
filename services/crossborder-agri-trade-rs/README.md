...
54Bank Crossborder Agri Trade service
...
# Run
PORT=8080 ./target/release/crossborder-agri-trade-rs
```
...
```bash
docker build -t 54bank/crossborder-agri-trade-rs .
docker run -p 8080:8080 54bank/crossborder-agri-trade-rs
```
