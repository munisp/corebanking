...
54Bank Fast Json Serializer service
...
# Run
PORT=8080 ./target/release/fast-json-serializer-rs
```
...
```bash
docker build -t 54bank/fast-json-serializer-rs .
docker run -p 8080:8080 54bank/fast-json-serializer-rs
```
