...
```bash
# Build
go build -o agent-farmer-onboarding-go .

# Run
PORT=6379 ./agent-farmer-onboarding-go
```
...
```bash
docker build -t 54bank/agent-farmer-onboarding-go .
docker run -p 6379:6379 54bank/agent-farmer-onboarding-go
```
