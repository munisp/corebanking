...
54Bank Secrets Rotation service
...
# Run
PORT=8080 ./target/release/secrets-rotation-rs
```
...
```bash
docker build -t 54bank/secrets-rotation-rs .
docker run -p 8080:8080 54bank/secrets-rotation-rs
```
