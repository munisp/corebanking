...
```bash
# Build
go build -o voice-agent-escalation-go .

# Run
PORT=6379 ./voice-agent-escalation-go
```
...
```bash
docker build -t 54bank/voice-agent-escalation-go .
docker run -p 6379:6379 54bank/voice-agent-escalation-go
```
