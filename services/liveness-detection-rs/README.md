...
54Bank Liveness Detection service
...
# Run
PORT=8226 ./target/release/liveness-detection-rs
```
...
```bash
docker build -t 54bank/liveness-detection-rs .
docker run -p 8226:8226 54bank/liveness-detection-rs
```
