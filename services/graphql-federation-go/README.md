...
54Bank Graphql Federation service

## Quick Start

```bash
# Build
go build -o graphql-federation-go .

# Run
PORT=8100 ./graphql-federation-go
```
...
```bash
docker build -t 54bank/graphql-federation-go .
docker run -p 8100:8100 54bank/graphql-federation-go
```
