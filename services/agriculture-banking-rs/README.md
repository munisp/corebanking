...
54Bank Agriculture Banking service
...
# Run
PORT=8080 ./target/release/agriculture-banking-rs
```
...
```bash
docker build -t 54bank/agriculture-banking-rs .
docker run -p 8080:8080 54bank/agriculture-banking-rs
```
