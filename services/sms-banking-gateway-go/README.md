...
```bash
# Build
go build -o sms-banking-gateway-go .

# Run
PORT=6379 ./sms-banking-gateway-go
```
...
```bash
docker build -t 54bank/sms-banking-gateway-go .
docker run -p 6379:6379 54bank/sms-banking-gateway-go
```
