...
54Bank Fraud Detection service
...
# Run
PORT=8080 ./target/release/fraud-detection-rs
```
...
```bash
docker build -t 54bank/fraud-detection-rs .
docker run -p 8080:8080 54bank/fraud-detection-rs
```
