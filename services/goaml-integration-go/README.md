...
```bash
# Build
go build -o goaml-integration-go .

# Run
PORT=6379 ./goaml-integration-go
```
...
```bash
docker build -t 54bank/goaml-integration-go .
docker run -p 6379:6379 54bank/goaml-integration-go
```
