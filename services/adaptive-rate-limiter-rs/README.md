...
54Bank Adaptive Rate Limiter service
...
# Run
PORT=8080 ./target/release/adaptive-rate-limiter-rs
```
...
```bash
docker build -t 54bank/adaptive-rate-limiter-rs .
docker run -p 8080:8080 54bank/adaptive-rate-limiter-rs
```
