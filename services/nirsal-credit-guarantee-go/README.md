...
```bash
# Build
go build -o nirsal-credit-guarantee-go .

# Run
PORT=6379 ./nirsal-credit-guarantee-go
```
...
```bash
docker build -t 54bank/nirsal-credit-guarantee-go .
docker run -p 6379:6379 54bank/nirsal-credit-guarantee-go
```
