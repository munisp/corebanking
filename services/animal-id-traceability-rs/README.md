...
54Bank Animal Id Traceability service
...
# Run
PORT=8080 ./target/release/animal-id-traceability-rs
```
...
```bash
docker build -t 54bank/animal-id-traceability-rs .
docker run -p 8080:8080 54bank/animal-id-traceability-rs
```
