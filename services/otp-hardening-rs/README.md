...
# Run
PORT=8080 ./target/release/otp-hardening-rs
```
...
```bash
docker build -t 54bank/otp-hardening-rs .
docker run -p 8080:8080 54bank/otp-hardening-rs
```
