...
# Run
PORT=8080 ./target/release/contract-test-rs
```
...
```bash
docker build -t 54bank/contract-test-rs .
docker run -p 8080:8080 54bank/contract-test-rs
```
