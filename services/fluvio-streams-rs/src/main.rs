...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[fluvio-streams-rs] starting");

    let db_name = "fluvio-streams-rs".replace("-", "_");
    ...
    log::info!("[fluvio-streams-rs] database connected, schema initialized");
    ...
    log::info!("[fluvio-streams-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[fluvio-streams-rs] ready on :{}", port);
