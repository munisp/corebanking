...
# Run
PORT=8080 ./target/release/fluvio-streams-rs
```
...
```bash
docker build -t 54bank/fluvio-streams-rs .
docker run -p 8080:8080 54bank/fluvio-streams-rs
```
