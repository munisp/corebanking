...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            self.respond(200, {"service": SERVICE_NAME, "endpoint": "funding_flows", "items": [], "source": "postgresql" if not _DB_URL else "postgres"})
    ...
    def do_POST(self):
        ...
        if path == "/v1/graph/query":
            ...
            _event_bus.emit("falkordb-coa.processed", {"action": "process", "status": "success"})
...
_event_bus = EventBus("platform.events", "falkordb-coa")
