...
```bash
# Build
go build -o microfinance-engine-go .

# Run
PORT=6379 ./microfinance-engine-go
```
...
```bash
docker build -t 54bank/microfinance-engine-go .
docker run -p 6379:6379 54bank/microfinance-engine-go
```
