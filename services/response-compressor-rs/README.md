...
54Bank Response Compressor service
...
# Run
PORT=8080 ./target/release/response-compressor-rs
```
...
```bash
docker build -t 54bank/response-compressor-rs .
docker run -p 8080:8080 54bank/response-compressor-rs
```
