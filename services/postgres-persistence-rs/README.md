...
54Bank Postgres Persistence service
...
# Run
PORT=8080 ./target/release/postgres-persistence-rs
```
...
```bash
docker build -t 54bank/postgres-persistence-rs .
docker run -p 8080:8080 54bank/postgres-persistence-rs
```
