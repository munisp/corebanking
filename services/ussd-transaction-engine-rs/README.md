# Ussd Transaction Engine

54Bank Ussd Transaction Engine service
...
# Run
PORT=8080 ./target/release/ussd-transaction-engine-rs
```
...
```bash
docker build -t 54bank/ussd-transaction-engine-rs .
docker run -p 8080:8080 54bank/ussd-transaction-engine-rs
```
