"""
agent-cash-management-py - Production-ready service with PostgreSQL persistence.
...
logger = logging.getLogger("agent-cash-management-py")
...
# Configuration
DATABASE_URL = os.getenv("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/agent_cash_management_py")
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/healthz": self.respond(200, {"status": "healthy", "service": SERVICE_NAME, "tools": AGENT_TOOLS})
            ...
            self.respond(200, {"service": "agent-cash-management-py", **_degrade.status()})
        elif path == "/v1/alerts":
