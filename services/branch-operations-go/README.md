...
```bash
# Build
go build -o branch-operations-go .

# Run
PORT=6379 ./branch-operations-go
```
...
```bash
docker build -t 54bank/branch-operations-go .
docker run -p 6379:6379 54bank/branch-operations-go
```
