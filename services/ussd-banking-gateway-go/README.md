...
```bash
# Build
go build -o ussd-banking-gateway-go .

# Run
PORT=6379 ./ussd-banking-gateway-go
```
...
```bash
docker build -t 54bank/ussd-banking-gateway-go .
docker run -p 6379:6379 54bank/ussd-banking-gateway-go
```
