...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[fatca-crs-rs] starting");

    let db_name = "fatca-crs-rs".replace("-", "_");
    ...
    log::info!("[fatca-crs-rs] database connected, schema initialized");
    ...
    log::info!("[fatca-crs-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[fatca-crs-rs] ready on :{}", port);
