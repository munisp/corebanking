...
54Bank Cache Invalidation service
...
# Run
PORT=8080 ./target/release/cache-invalidation-rs
```
...
```bash
docker build -t 54bank/cache-invalidation-rs .
docker run -p 8080:8080 54bank/cache-invalidation-rs
```
