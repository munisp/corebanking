...
class KafkaClient:
    ...
    def publish_report_event(self, event_type: str, report_id: str, tenant_id: str, status: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
        event = {
            "type": event_type,
            "report_id": report_id,
            "tenant_id": tenant_id,
        ...
        return self.publish_event(ComplianceTopics.REPORT, event, key=str(report_id))

    def publish_alert_event(self, event_type: str, alert_id: str, tenant_id: str, severity: str, metadata: Optional[Dict[str, Any]] = None):
        event = {
            "type": event_type,
            "alert_id": alert_id,
            "tenant_id": tenant_id,
        ...
        return self.publish_event(ComplianceTopics.ALERT, event, key=str(alert_id))
