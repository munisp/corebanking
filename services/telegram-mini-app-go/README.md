...
```bash
# Build
go build -o telegram-mini-app-go .

# Run
PORT=6379 ./telegram-mini-app-go
```
...
```bash
docker build -t 54bank/telegram-mini-app-go .
docker run -p 6379:6379 54bank/telegram-mini-app-go
```
