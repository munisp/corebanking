...
54Bank Ubo Ownership Graph service
...
# Run
PORT=8080 ./target/release/ubo-ownership-graph-rs
```
...
```bash
docker build -t 54bank/ubo-ownership-graph-rs .
docker run -p 8080:8080 54bank/ubo-ownership-graph-rs
```
