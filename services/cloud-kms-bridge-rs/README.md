...
54Bank Cloud Kms Bridge service
...
# Run
PORT=8080 ./target/release/cloud-kms-bridge-rs
```
...
```bash
docker build -t 54bank/cloud-kms-bridge-rs .
docker run -p 8080:8080 54bank/cloud-kms-bridge-rs
```
