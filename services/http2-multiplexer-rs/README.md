...
54Bank Http2 Multiplexer service
...
# Run
PORT=8080 ./target/release/http2-multiplexer-rs
```
...
```bash
docker build -t 54bank/http2-multiplexer-rs .
docker run -p 8080:8080 54bank/http2-multiplexer-rs
```
