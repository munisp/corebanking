...
func healthz(w http.ResponseWriter, _ *http.Request) {
	...
	json.NewEncoder(w).Encode(map[string]interface{}{
		...
		"middleware": map[string]interface{}{
			...
			"postgres":    map[string]interface{}{"url": envOr("DATABASE_URL", "postgresql://ndsep_user:ndsep_secure_2026@localhost:5432/ndsep_db"), "tables": []string{"lease_contracts","lease_payments","leased_assets"}},
