...
54Bank Postgres Query Cache service
...
# Run
PORT=8080 ./target/release/postgres-query-cache-rs
```
...
```bash
docker build -t 54bank/postgres-query-cache-rs .
docker run -p 8080:8080 54bank/postgres-query-cache-rs
```
