...
54Bank Vault Integration service
...
# Run
PORT=8080 ./target/release/vault-integration-rs
```
...
```bash
docker build -t 54bank/vault-integration-rs .
docker run -p 8080:8080 54bank/vault-integration-rs
```
