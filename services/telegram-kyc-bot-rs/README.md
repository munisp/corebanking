...
54Bank Telegram Kyc Bot service
...
# Run
PORT=8080 ./target/release/telegram-kyc-bot-rs
```
...
```bash
docker build -t 54bank/telegram-kyc-bot-rs .
docker run -p 8080:8080 54bank/telegram-kyc-bot-rs
```
