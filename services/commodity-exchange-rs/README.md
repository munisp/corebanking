...
54Bank Commodity Exchange service
...
# Run
PORT=8080 ./target/release/commodity-exchange-rs
```
...
```bash
docker build -t 54bank/commodity-exchange-rs .
docker run -p 8080:8080 54bank/commodity-exchange-rs
```
