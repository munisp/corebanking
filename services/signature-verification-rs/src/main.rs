...
async fn main() -> std::io::Result<()> {
    ...
    log::info!("[signature-verification-rs] starting");

    let db_name = "signature-verification-rs".replace("-", "_");
    ...
    log::info!("[signature-verification-rs] database connected, schema initialized");
    ...
    log::info!("[signature-verification-rs] middleware: keycloak={} kafka={} redis={} opensearch={} permify={}",
    ...
    log::info!("[signature-verification-rs] ready on :{}", port);
