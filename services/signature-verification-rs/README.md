...
54Bank Signature Verification service
...
# Run
PORT=8080 ./target/release/signature-verification-rs
```
...
```bash
docker build -t 54bank/signature-verification-rs .
docker run -p 8080:8080 54bank/signature-verification-rs
```
