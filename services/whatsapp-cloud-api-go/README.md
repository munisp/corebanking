...
```bash
# Build
go build -o whatsapp-cloud-api-go .

# Run
PORT=6379 ./whatsapp-cloud-api-go
```
...
```bash
docker build -t 54bank/whatsapp-cloud-api-go .
docker run -p 6379:6379 54bank/whatsapp-cloud-api-go
```
