...
54Bank Read Replica Router service
...
# Run
PORT=8080 ./target/release/read-replica-router-rs
```
...
```bash
docker build -t 54bank/read-replica-router-rs .
docker run -p 8080:8080 54bank/read-replica-router-rs
```
