...
# Run
PORT=8080 ./target/release/sri-validator-rs
```
...
```bash
docker build -t 54bank/sri-validator-rs .
docker run -p 8080:8080 54bank/sri-validator-rs
```
