...
54Bank Collateral Valuation service
...
# Run
PORT=8080 ./target/release/collateral-valuation-rs
```
...
```bash
docker build -t 54bank/collateral-valuation-rs .
docker run -p 8080:8080 54bank/collateral-valuation-rs
```
