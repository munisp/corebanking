...
"""
telegram-notification-py — Production-hardened service
"""
import os
import sys
import json
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/cache-metrics":
            ...
            if err:
                ...
                return
            items, total = db_query("telegram_notification_py")
    ...
    def do_POST(self):
        ...
        if path == "/v1/create":
            ...
            _event_bus.emit("telegram-notification.processed", {"action": "process", "status": "success"})
...
_event_bus = EventBus("notifications.delivery", "telegram-notification")

if __name__ == "__main__":
    get_db()
    server = HTTPServer(("0.0.0.0", PORT), Handler)
    logger.info(json.dumps({"service": "telegram-notification-py", "port": PORT, "message": "starting"}))
    try:
