...
54Bank Langchain Agent service

## Quick Start

```bash
# Build
go build -o langchain-agent-go .

# Run
PORT=8080 ./langchain-agent-go
```
...
```bash
docker build -t 54bank/langchain-agent-go .
docker run -p 8080:8080 54bank/langchain-agent-go
```
