...
54Bank Neo4J Coa Graph service

## Quick Start

```bash
# Build
go build -o neo4j-coa-graph-go .

# Run
PORT=8103 ./neo4j-coa-graph-go
```
...
```bash
docker build -t 54bank/neo4j-coa-graph-go .
docker run -p 8103:8103 54bank/neo4j-coa-graph-go
```
