...
def test_payment_service_seed_exists():
    seed_path = Path(__file__).parent.parent.parent / "services/payment-service/seed_data.json"
...
def test_payment_service_service_has_runtime_entrypoint():
    service_dir = Path(__file__).parent.parent.parent / "services/payment-service"
