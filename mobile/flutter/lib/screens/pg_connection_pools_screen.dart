...
class _PGConnectionPoolsScreenState extends State<PGConnectionPoolsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Pg Connection Pools - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Pg Connection Pools - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Pg Connection Pools - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Pg Connection Pools - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search pg connection pools...',
