...
class LakehouseMaterializedViewsScreen extends StatefulWidget {
  const LakehouseMaterializedViewsScreen({super.key});
  @override
  State<LakehouseMaterializedViewsScreen> createState() => _LakehouseMaterializedViewsScreenState();
}

class _LakehouseMaterializedViewsScreenState extends State<LakehouseMaterializedViewsScreen> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lakehouse Materialized Views'), backgroundColor: Colors.green[700]),
      body: Padding(
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search lakehouse materialized views...',
