...
class _OTELConfigsScreenState extends State<OTELConfigsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Otel Configs - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Otel Configs - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Otel Configs - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Otel Configs - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
