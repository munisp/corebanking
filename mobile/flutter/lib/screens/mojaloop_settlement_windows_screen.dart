...
class _MojaloopSettlementWindowsScreenState extends State<MojaloopSettlementWindowsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Mojaloop Settlement Windows - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Mojaloop Settlement Windows - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Mojaloop Settlement Windows - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Mojaloop Settlement Windows - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search mojaloop settlement windows...',
