...
class _PGSlowQueriesScreenState extends State<PGSlowQueriesScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Pg Slow Queries - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Pg Slow Queries - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Pg Slow Queries - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Pg Slow Queries - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search pg slow queries...',
