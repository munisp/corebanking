...
class _NotificationsEngineScreenState extends State<NotificationsEngineScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Notifications Engine - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Notifications Engine - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Notifications Engine - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Notifications Engine - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search notifications engine...',
