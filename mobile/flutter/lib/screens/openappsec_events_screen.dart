...
class _OpenappsecEventsScreenState extends State<OpenappsecEventsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Openappsec Events - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Openappsec Events - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Openappsec Events - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Openappsec Events - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search openappsec events...',
