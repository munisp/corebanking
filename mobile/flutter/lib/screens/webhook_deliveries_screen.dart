...
class _WebhookDeliveriesScreenState extends State<WebhookDeliveriesScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Webhook Deliveries - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Webhook Deliveries - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Webhook Deliveries - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Webhook Deliveries - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
