...
class _SARFilingEngineScreenState extends State<SARFilingEngineScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'S A R Filing Engine - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'S A R Filing Engine - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'S A R Filing Engine - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'S A R Filing Engine - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search s a r filing engine...',
