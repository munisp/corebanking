...
class _MojaloopCorridorsScreenState extends State<MojaloopCorridorsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Mojaloop Corridors - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Mojaloop Corridors - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Mojaloop Corridors - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Mojaloop Corridors - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search mojaloop corridors...',
