...
class _DistrolessBuilderScreenState extends State<DistrolessBuilderScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Distroless Builder - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Distroless Builder - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Distroless Builder - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Distroless Builder - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search distroless builder...',
