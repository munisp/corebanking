...
class _SARReportsScreenState extends State<SARReportsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Sar Reports - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Sar Reports - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Sar Reports - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Sar Reports - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
