...
class LakehouseClientsScreen extends StatefulWidget {
  const LakehouseClientsScreen({super.key});
  @override
  State<LakehouseClientsScreen> createState() => _LakehouseClientsScreenState();
}

class _LakehouseClientsScreenState extends State<LakehouseClientsScreen> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lakehouse Clients'), backgroundColor: Colors.green[700]),
      body: Padding(
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search lakehouse clients...',
