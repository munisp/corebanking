...
class _KYCEventRulesScreenState extends State<KYCEventRulesScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Kyc Event Rules - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Kyc Event Rules - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Kyc Event Rules - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Kyc Event Rules - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search kyc event rules...',
