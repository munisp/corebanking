...
class LakehouseScreen extends StatefulWidget {
  const LakehouseScreen({super.key});
  @override
  State<LakehouseScreen> createState() => _LakehouseScreenState();
}

class _LakehouseScreenState extends State<LakehouseScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lakehouse'), backgroundColor: Colors.green[700]),
