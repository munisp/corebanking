...
class LakehouseCDCEventsScreen extends StatefulWidget {
  const LakehouseCDCEventsScreen({super.key});
  @override
  State<LakehouseCDCEventsScreen> createState() => _LakehouseCDCEventsScreenState();
}

class _LakehouseCDCEventsScreenState extends State<LakehouseCDCEventsScreen> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lakehouse CDC Events'), backgroundColor: Colors.green[700]),
      body: Padding(
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search lakehouse cdc events...',
