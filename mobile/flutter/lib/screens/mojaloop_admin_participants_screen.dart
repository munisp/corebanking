...
class _MojaloopAdminParticipantsScreenState extends State<MojaloopAdminParticipantsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Mojaloop Admin Participants - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Mojaloop Admin Participants - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Mojaloop Admin Participants - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Mojaloop Admin Participants - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search mojaloop admin participants...',
