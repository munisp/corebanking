...
class _OTELCollectorScreenState extends State<OTELCollectorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Otel Collector'), backgroundColor: Colors.green[700]),
        ...
        child: Column(
          ...
          children: [
            ...
            Card(child: ListTile(
              ...
              title: Text('Otel Collector Primary'),
            ...
            Card(child: ListTile(
              leading: Icon(Icons.circle, color: Colors.green[400], size: 12),
              title: Text('Otel Collector Secondary'),
            ...
            Card(child: ListTile(
              leading: Icon(Icons.circle, color: Colors.green[400], size: 12),
              title: Text('Otel Collector Canary'),
              subtitle: Text('Test'),
              trailing: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
