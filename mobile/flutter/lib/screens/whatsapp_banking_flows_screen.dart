...
class _WhatsappBankingFlowsScreenState extends State<WhatsappBankingFlowsScreen> {
  ...
  final List<Map<String, dynamic>> _items = [
    {'name': 'Whatsapp Banking Flows - Standard', 'type': 'Core Product', 'value': '₦5.2B', 'status': 'Active'},
    {'name': 'Whatsapp Banking Flows - Premium', 'type': 'Enhanced', 'value': '₦3.8B', 'status': 'Active'},
    {'name': 'Whatsapp Banking Flows - Enterprise', 'type': 'Corporate', 'value': '₦8.5B', 'status': 'Active'},
    {'name': 'Whatsapp Banking Flows - Digital', 'type': 'Online Channel', 'value': '₦2.1B', 'status': 'Active'},
  ];
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search whatsapp banking flows...',
