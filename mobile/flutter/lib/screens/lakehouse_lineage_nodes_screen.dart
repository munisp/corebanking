...
class LakehouseLineageNodesScreen extends StatefulWidget {
  const LakehouseLineageNodesScreen({super.key});
  @override
  State<LakehouseLineageNodesScreen> createState() => _LakehouseLineageNodesScreenState();
}

class _LakehouseLineageNodesScreenState extends State<LakehouseLineageNodesScreen> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lakehouse Lineage Nodes'), backgroundColor: Colors.green[700]),
      body: Padding(
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search lakehouse lineage nodes...',
