...
describe("E2E: OAuth2/SSO Flow", () => {
  ...
  it("GET /api/auth/oauth2/authorize — returns authorization URL", async (ctx) => {
  ...
  it("GET /api/auth/oauth2/callback — missing params returns 400", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/auth/oauth2/callback — invalid state returns 400", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/auth/oauth2/callback — error param returns 400", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("POST /api/auth/oauth2/refresh — missing token returns 400", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/auth/oauth2/userinfo — no token returns 401", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("POST /api/auth/oauth2/logout — returns logout info", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/auth/oauth2/.well-known/openid-configuration — returns OIDC discovery", async (ctx) => {
    if (!serverUp) return ctx.skip();
...
describe("E2E: SSO Configuration", () => {
  ...
  it("GET /api/platform/sso/config — returns SSO configuration", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/platform/sso/roles — returns role definitions", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/platform/keycloak/config — returns Keycloak config", async (ctx) => {
    if (!serverUp) return ctx.skip();
  ...
  it("GET /api/platform/oauth2/endpoints — returns OAuth2 URLs", async (ctx) => {
    if (!serverUp) return ctx.skip();
