    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ color: "#fff", fontSize: 24, margin: "0 0 4px", fontWeight: 700 }}>54Bank Platform</h1>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gap: 4, fontSize: 12, color: "rgba(255,255,255,0.6)" }}>
            <div><b style={{ color: "rgba(255,255,255,0.8)" }}>Admin:</b> admin@54bank.ng / admin</div>
            <div><b style={{ color: "rgba(255,255,255,0.8)" }}>Operations:</b> ops@54bank.ng / ops123</div>
            <div><b style={{ color: "rgba(255,255,255,0.8)" }}>Compliance:</b> compliance@54bank.ng / comp123</div>
            <div><b style={{ color: "rgba(255,255,255,0.8)" }}>Treasury:</b> treasury@54bank.ng / treas123</div>
            <div><b style={{ color: "rgba(255,255,255,0.8)" }}>Branch:</b> branch@54bank.ng / branch123</div>
          </div>
        </div>

        <p style={{ textAlign: "center", color: "rgba(255,255,255,0.3)", fontSize: 11, marginTop: 24 }}>
          54Bank Platform v2.0 — Africa-First Core Banking
        </p>
      </div>
    </div>
  );
