// Design philosophy: archive-first restoration of the broader 54Bank administrative information architecture.
...
function ArchiveAdminWorkspace({
  domainKey,
  eyebrow,
  title,
  description,
      ...
      <div className="rounded-[1.8rem] border border-slate-200 bg-white p-6 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-slate-600">Manage all MFBs on the 54Bank platform</p>
          </div>
