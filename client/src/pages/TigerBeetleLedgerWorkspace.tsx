...
export default function TigerBeetleLedgerWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"description",label:"Description"},{key:"ledger",label:"Ledger"},{key:"balance",label:"Balance"},{key:"debitsPosted",label:"Debits"},{key:"creditsPosted",label:"Credits"},{key:"tenantId",label:"Tenant"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>TigerBeetle Ledger</h1>
      {stats && (
