...
export default function KafkaEventBusWorkspace() {
  ...
  const columns: Column[] = [{key:"name",label:"Topic"},{key:"partitions",label:"Partitions"},{key:"replicationFactor",label:"Replication"},{key:"retentionMs",label:"Retention (ms)"},{key:"consumerGroups",label:"Consumer Groups"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Kafka Event Bus</h1>
      {stats && (
