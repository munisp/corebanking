// Design philosophy: faithful recovery of the extracted 54Bank admin information architecture.
      ...
      >
        <div className="grid gap-4 lg:grid-cols-3">
          <article className="rounded-[1.4rem] border border-stone-100 bg-stone-50 p-5">
            ...
            <p className="mt-2 text-xl font-semibold text-stone-900">{authContext?.issuer ?? "54Bank"}</p>
  ...
  return (
    ...
    >
      <SectionCard
        ...
        description="These indicators translate the extracted dashboard’s analytics intent into the current 54Bank platform data model."
      >
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <article className="rounded-[1.4rem] border border-stone-100 bg-stone-50 p-5">
            <div className="flex items-center justify-between gap-3">
