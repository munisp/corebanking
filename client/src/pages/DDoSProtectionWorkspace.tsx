...
export default function DDoSProtectionWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"name",label:"Name"},{key:"type",label:"Type"},{key:"threshold",label:"Threshold"},{key:"window",label:"Window"},{key:"action",label:"Action"},{key:"enabled",label:"Enabled"},{key:"triggerCount",label:"Triggers"}];
  ...
  return (
    <div style={{ padding: "24px" }}>
      <h2 style={{ marginBottom: "16px" }}>DDoS Protection</h2>
      <input
        type="text"
        placeholder="Search..."
        value={search}
