...
export default function OpenBankingWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"name",label:"TPP Name"},{key:"type",label:"Type"},{key:"cbnLicense",label:"CBN License"},{key:"consentCount",label:"Consents"},{key:"apiKeys",label:"API Keys"},{key:"status",label:"Status"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Open Banking API</h1>
      {stats && (
