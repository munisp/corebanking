...
export default function AuditTrailWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"entityType",label:"Entity"},{key:"action",label:"Action"},{key:"actorEmail",label:"Actor"},{key:"geoLocation",label:"Location"},{key:"channel",label:"Channel"},{key:"createdAt",label:"Timestamp"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Immutable Audit Trail</h1>
      {stats && (
