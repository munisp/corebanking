...
export default function ENairaWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"walletAddress",label:"Wallet"},{key:"tier",label:"Tier"},{key:"balance",label:"Balance"},{key:"kycLevel",label:"KYC Level"},{key:"status",label:"Status"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>eNaira CBDC</h1>
      {stats && (
