...
export default function DatabasePersistenceWorkspace() {
  ...
  const columns: Column[] = [{key:"name",label:"Table"},{key:"columns",label:"Columns"},{key:"rlsPolicy",label:"RLS Policy"},{key:"tenantScoped",label:"Tenant Scoped"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Database Persistence</h1>
      {stats && (
