...
export default function SecurityHardeningWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"name",label:"Name"},{key:"category",label:"Category"},{key:"severity",label:"Severity"},{key:"enforced",label:"Enforced"},{key:"autoRemediate",label:"Auto-Remediate"}];
  ...
  return (
    <div style={{ padding: "24px" }}>
      <h2 style={{ marginBottom: "16px" }}>Security Hardening</h2>
      <input
        type="text"
        placeholder="Search..."
        value={search}
