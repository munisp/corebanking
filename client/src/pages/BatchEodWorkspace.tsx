...
export default function BatchEodWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"name",label:"Job"},{key:"type",label:"Type"},{key:"schedule",label:"Schedule"},{key:"lastRunStatus",label:"Status"},{key:"affectedRecords",label:"Records"},{key:"lastRunDurationMs",label:"Duration (ms)"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Batch / EOD Engine</h1>
      {stats && (
