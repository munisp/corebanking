...
export default function EmbeddedFinanceWorkspace() {
  ...
  const columns: Column[] = [{key:"id",label:"ID"},{key:"name",label:"Partner"},{key:"industry",label:"Industry"},{key:"platform",label:"Platform"},{key:"monthlyApiCalls",label:"Monthly API Calls"},{key:"status",label:"Status"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Embedded Finance SDK</h1>
      {stats && (
