...
export default function MultiCurrencyFxWorkspace() {
  ...
  const columns: Column[] = [{key:"baseCurrency",label:"Base"},{key:"quoteCurrency",label:"Quote"},{key:"buyRate",label:"Buy"},{key:"sellRate",label:"Sell"},{key:"midRate",label:"Mid"},{key:"spread",label:"Spread"},{key:"source",label:"Source"}];
  ...
  return (
    <div style={{padding:"1.5rem"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Multi-Currency FX</h1>
      {stats && (
