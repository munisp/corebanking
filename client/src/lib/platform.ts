...
const defaultTenantConfigurations: TenantConfiguration[] = [
  {
    ...
    whiteLabel: {
      ...
      legalEntity: "54Bank Retail Operations Ltd.",
      supportEmail: "retail-ops@54bank.app",
      primaryColor: "#0f766e",
      accentColor: "#f59e0b",
      logoUrl: "https://assets.54bank.app/logos/54bank-retail.png",
      loginHeadline: "Retail banking experiences, branded per tenant.",
      customDomain: "retail.54bank.app",
    },
  },
  {
    tenantId: "54-ops",
    ...
    whiteLabel: {
      ...
      legalEntity: "54Bank Settlement Services Ltd.",
      supportEmail: "ops-control@54bank.app",
      primaryColor: "#1d4ed8",
      accentColor: "#22c55e",
      logoUrl: "https://assets.54bank.app/logos/54bank-ops.png",
      loginHeadline: "Settlement, treasury, and control workflows in one tenant shell.",
      customDomain: "ops.54bank.app",
    },
  },
  {
    tenantId: "54-growth",
    ...
    whiteLabel: {
      ...
      legalEntity: "54Bank Growth Programs Ltd.",
      supportEmail: "growth-launch@54bank.app",
      primaryColor: "#7c3aed",
      accentColor: "#fb7185",
      logoUrl: "https://assets.54bank.app/logos/54bank-growth.png",
      loginHeadline: "Partner-led acquisition journeys with tenant-specific launch controls.",
      customDomain: "growth.54bank.app",
    },
  },
];
...
const defaultAuthContext: AuthContextResponse = {
  ...
  issuer: "http://keycloak:8080/realms/54bank",
  authzEndpoint: "http://permify:3476",
  gateway: "https://api.54bank.internal/gateway",
...
const fallbackTigerBeetle: TigerBeetleIntegrationResponse = {
  ...
  config: {
    ...
    keycloak: { issuer: "http://keycloak:8080/realms/54bank" },
    permify: { endpoint: "http://permify:3476" },
    redis: { url: "redis://redis-master:6379/0" },
    apisix: { publicGatewayUrl: "https://api.54bank.internal/gateway" },
    mojaloop: { endpoint: "http://mojaloop-switch.default.svc.cluster.local:4000" },
    postgres: { url: "postgresql://app_user:54bank-postgres-secret@postgres-primary:5432/app_db?sslmode=require" },
